...
using MyMath.Symbolic;

namespace MyMath.Numeric
{
  /// <summary>
  ...
  public class SurfaceDynamics : DynamicalSystem
  {
    ...
    /// </summary>
		public void SetFunctions(
			...
			Expression2 phi)
    {
			var x_ = new MyMath.Symbolic.Lambda(x);
			var y_ = new MyMath.Symbolic.Lambda(y);
			var z_ = new MyMath.Symbolic.Lambda(z);
			var phi_ = new MyMath.Symbolic.Lambda(phi);
