...
namespace MyMath.Symbolic
{
	...
	public abstract class Expression : IComparable
	{
		...
		/// <summary>
		/// check whether this is identical to e or not.
		/// (x + 1) and (1 + x) are identical in the result of this method.
		/// (This is reason why the method name is not "Equals".)
		/// </summary>
		...
		/// <summary>
		/// check whether e1 is identical to e2 or not, with null check.
		/// </summary>
		...
		/// <summary>
		/// Convart from System.Linq.Expressions.Expression.
		/// </summary>
		...
		/// <summary>
		/// flag that signals if this instance is already simplified.
		/// </summary>
		...
		/// <summary>
		/// spetial optimization sush like sin^2 + cos^2 -> 1.
		/// </summary>
		...
		static void AddWithFolding(List<Term> to, IEnumerable<Term> adding)
		{
		...
		/// <summary>
		/// multiply an Exression and a Term.
		/// </summary>
		/// <param name="e">operand 1</param>
		/// <param name="t">operand 2</param>
		/// <returns>result</returns>
